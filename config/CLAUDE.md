...
- Never hand a lint error or failing test to the user. If a repo has `prek` (or `pre-commit`), run it against changed files before ending a turn and fix what it reports.
